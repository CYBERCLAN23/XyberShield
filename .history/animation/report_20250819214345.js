...
function initializeForm() {
 ...
 // Afficher la première étape
  ...
  function showStep(stepIndex) {
    ...
    console.log(`Affichage de l'étape ${currentStep + 1}/${steps.length}`);
  }
  ...
  function updateProgressBar() {
    ...
    // Mettre à jour les étapes de la barre de progression
  ...
  function validateStep(stepIndex) {
    console.log(`Validation de l'étape ${stepIndex + 1}`);
    
    // Récupérer tous les champs requis de l'étape actuelle
