...
function toggleForm(){
    const container = document.getElementById("container"),
          ...
          regis = document.getElementById("register-form"),
          btn = document.getElementById("switch-btn");

          if(isLogin){
            container.classList.add("switch");
            login.classList.replace("show","hide");
            regis.classList.replace("hide","show");
            btn.innerHTML='<i class="fas fa-sign-in-alt"></i>Login'
          }
          else{
             container.classList.add("switch");
              regis.classList.replace("show","hide");
            login.classList.replace("hide","show");
           
            btn.innerHTML='<i class="fas fa-sign-in-alt"></i>Register'
          }
    isLogin=!isLogin
}
